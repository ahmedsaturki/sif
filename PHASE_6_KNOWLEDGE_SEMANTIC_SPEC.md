...
## Status
VERIFIED CANDIDATE SPEC — the Phase 6 runtime is implemented and previously exact-head verified; after re-anchoring to the current Phase 5 candidate it must pass exact-head verification again before any promotion.
