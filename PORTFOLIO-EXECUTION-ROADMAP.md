...
| ai-team-v1 | `main` is `39dc7790eb1483e7dfc54eedb87e4a94f8e1ae0f`; PR #76 and the documentation reconciliation PR #77 are merged; latest main CI evidence remains successful; no open PRs/issues | Keep stable; take the next product requirement only when evidence exists |
