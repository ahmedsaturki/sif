...
export type SovereignProductId = "LARA_OS_REIE" | "QADRIX" | "SOVEREIGN_LIBRARY" | (string & {});
export type ProductPlane = "FEDERATION" | "POLICY" | "OBSERVABILITY" | "KNOWLEDGE" | "SYSTEMIC" | "CONTINUITY";
